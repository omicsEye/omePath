...
theme_omicsEye <- function()
  list(
    ...
    ggplot2::theme(
      ...
      axis.title.x       = ggplot2::element_text(size = 7, margin = ggplot2::margin(1, 0, 0.5, 0)),
      axis.title.x.top   = ggplot2::element_text(margin = ggplot2::margin(0, 0, 2, 0)),
      axis.title.y       = ggplot2::element_text(size = 7, margin = ggplot2::margin(0, 1, 0, 0.5)),
      axis.title.y.right = ggplot2::element_text(margin = ggplot2::margin(0, 0, 0, 2)),
      axis.text.x        = ggplot2::element_text(size = 7, margin = ggplot2::margin(1, 0, 0, 0)),
      axis.text.x.top    = ggplot2::element_text(margin = ggplot2::margin(0, 0, 1, 0)),
      axis.text.y        = ggplot2::element_text(size = 5, margin = ggplot2::margin(0, 1, 0, 0)),
